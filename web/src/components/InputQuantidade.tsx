...
export default function InputQuantidade() {
  ...
  return (
    <div className="flex flex-row mx-0 my-5" id="container_tamanhos">
      ...
      <input
        className={`ml-3 py-3 w-[160px] border-black h-8 border rounded text-sm placeholder:text-zinc-500 p-2 shadow-[0px_3px_5px_#0000008a] leading-normal text-center`}
        ...
        style={{ appearance: "textfield", MozAppearance: "textfield" }} // Added style to hide arrows
      />
    </div>
  );
}
